...
class Nav extends Component {
    ...
    renderMessage(correct, gameWon, clear = false) {
        ...
        if(clear) {
            ...
            message = 'Click an image below to begin playing'
            className = ''
        } else {
            message = gameWon ? 'Awesome! You won the game!!!' : (correct ? 'Your Guess was Correct!!' : 'Your Guess was Incorrect!!')
            ...
            <nav className="pinned">
                <div>
                    <ul className="center navList">
                        <li className="logo">Icon Clicky Game</li>
